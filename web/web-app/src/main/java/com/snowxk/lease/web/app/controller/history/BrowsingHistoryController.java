package com.snowxk.lease.web.app.controller.history;
...
import com.snowxk.lease.web.app.vo.history.HistoryItemVo;
...
public class BrowsingHistoryController {
    ...
    public Result<IPage<HistoryItemVo>> page(@RequestParam long current, @RequestParam long size) {
        ...
        IPage<HistoryItemVo> result = service.pageHistoryItemByUserId(page, userId);
