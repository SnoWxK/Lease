...
import com.snowxk.lease.web.admin.mapper.*;
import com.snowxk.lease.web.admin.service.*;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.snowxk.lease.web.admin.vo.apartment.ApartmentDetailVo;
import com.snowxk.lease.web.admin.vo.apartment.ApartmentItemVo;
import com.snowxk.lease.web.admin.vo.apartment.ApartmentQueryVo;
import com.snowxk.lease.web.admin.vo.apartment.ApartmentSubmitVo;
import com.snowxk.lease.web.admin.vo.fee.FeeValueVo;
import com.snowxk.lease.web.admin.vo.graph.GraphVo;
...
public class ApartmentInfoServiceImpl extends ServiceImpl<ApartmentInfoMapper, ApartmentInfo>
    ...
    public void saveOrUpdateApartment(ApartmentSubmitVo apartmentSubmitVo) {
        ...
        if (!CollectionUtils.isEmpty(facilityInfoIdList)) {
            List<ApartmentFacility> facilityInfoList = new ArrayList<>();
            for (Long facilityInfoId : facilityInfoIdList) {
                ApartmentFacility apartmentFacility = new ApartmentFacility();
                apartmentFacility.setApartmentId(apartmentSubmitVo.getId());
                apartmentFacility.setFacilityId(facilityInfoId);
                facilityInfoList.add(apartmentFacility);
            }
            apartmentFacilityService.saveBatch(facilityInfoList);
        }
